...
const AboutText = () => {
    ...
    return (
        <div className = "row">
            ...
            {/* modal cm automazione */}
            <div className="modal fade" id="automazione" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div className="modal-content">
                    <div className="modal-header">
